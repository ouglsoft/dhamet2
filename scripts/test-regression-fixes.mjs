...
assert.doesNotMatch(shell, /deleteIndexedDatabase/);
assert.match(shell, /Remove only obsolete connection markers/);
...
assert.match(shell, /2026-07-28-session-audit-clean-v3/);
