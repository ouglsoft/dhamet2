  ...
  "ar": {
    ...
    "pvp": {
      "voice": {
        ...
        "failedBody": "تعذر تشغيل الدردشة الصوتية. تحقق من إذن الميكروفون ثم أعد المحاولة.",
    ...
    "status": {
      ...
      "onlineInitHelp": "يرجى تسجيل الدخول أو تفعيل المصادقة المجهولة (Anonymous) في Firebase.",
    ...
    "meta_keywords": "ظامت, زامت, لعبة موريتانية, لعب عبر الإنترنت, نظام احتياطي",
    "online": {
      ...
      "invites": {
        ...
        "inActiveMatch": "لا يمكنك إرسال أو استقبال الدعوات وأنت طرف في مباراة جارية. عد إلى المباراة أو أنهها أولا."
      },
      "status": {
        "available": "متاح",
    ...
    "meta_description": "نظام احتياطي مستقل للعب ظامت عبر الإنترنت بجلسات مجهولة ومباريات غير مصنفة.",
    "topbar": {
      "login": "تسجيل الدخول",
      "logout": "تسجيل الخروج",
      "account": "الحساب"
  ...
  "en": {
    ...
    "pvp": {
      "voice": {
        ...
        "failedBody": "Voice chat could not start. Check microphone permission, then try again.",
    ...
    "status": {
      ...
      "onlineInitHelp": "Please sign in or enable Anonymous authentication in Firebase.",
      "loading": "Loading…",
    ...
    "meta_keywords": "zamat, dhamet, mauritanian game, online multiplayer, emergency service",
    "online": {
      ...
      "invites": {
        ...
        "inActiveMatch": "You cannot send or receive invites while you are part of an active match. Return to the match or end it first."
      },
      "status": {
        "available": "Available",
    ...
    "meta_description": "An independent emergency Dhamet online-play service with anonymous, unranked matches.",
    "topbar": {
      "logout": "Sign out",
      "account": "Account",
      "login": "Log in"
  ...
  "fr": {
    ...
    "pvp": {
      "voice": {
        ...
        "failedBody": "Impossible de démarrer le chat vocal. Vérifiez l’autorisation du microphone puis réessayez.",
    ...
    "status": {
      ...
      "onlineInitHelp": "Veuillez vous connecter ou activer l’authentification anonyme (Anonymous) dans Firebase.",
      "loading": "Chargement…",
    ...
    "online": {
      ...
      "invites": {
        ...
        "inActiveMatch": "Vous ne pouvez pas envoyer ni recevoir d’invitations pendant une partie en cours. Revenez à la partie ou terminez-la d’abord."
      },
    ...
    "meta_description": "Service de secours indépendant pour jouer à Dhamet en ligne avec des sessions anonymes et non classées.",
    "topbar": {
      "logout": "Déconnexion",
      "account": "Compte",
      "login": "Connexion"
